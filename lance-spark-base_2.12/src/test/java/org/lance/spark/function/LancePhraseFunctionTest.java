...
public class LancePhraseFunctionTest {
  ...
  public void testName() {
    ...
    assertEquals("lance_phrase", fn.name());
  }
  ...
  public void testBoundNameAndCanonicalName() {
    ...
    assertEquals("lance_phrase", bound2.name());
    assertEquals("lance_phrase", bound2.canonicalName());

    ScalarFunction<Boolean> bound3 = (ScalarFunction<Boolean>) fn.bind(phraseSchema3());
    assertEquals("lance_phrase", bound3.name());
    assertEquals("lance_phrase", bound3.canonicalName());
  }
